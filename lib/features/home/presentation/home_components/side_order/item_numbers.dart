...
class ItemSelector extends StatefulWidget {
  ...
  final int floorId;
  const ItemSelector({required this.floorId,required this.menuItem, super.key});
        ...
        child: Row(
          ...
          children: [
            _buildButton(Icons.remove, () {
              if (widget.menuItem.requiredQuantity>0) {
                setState(() {
                  widget.menuItem.requiredQuantity=1;
                  BlocProvider.of<AddMenuToCartBloc>(context).add(AddMenuToCartPressed(widget.menuItem.id, widget.menuItem.requiredQuantity,widget.floorId,ApiMethods.substractMethod));
                });
              }
            }),
            const SizedBox(
            ...
            Container(
              ...
              child: AnimatedFlipCounter(
                value: widget.menuItem.requiredQuantity,
            ...
            setState(() {
              ...
              BlocProvider.of<AddMenuToCartBloc>(context).add(AddMenuToCartPressed(widget.menuItem.id, widget.menuItem.minQty,widget.floorId,ApiMethods.addMethod));
            });
